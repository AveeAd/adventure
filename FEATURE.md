...
| 16 | Trail elevation profiles + activity tracks — TRAIL_ELEVATION.md (GPX import, `TrailElevationProfile`) and ACTIVITY_TRACKS.md (`ActivityTrack`, KML/KMZ/GeoJSON import, promote-to-trail) built together, one parser module | not started | Phase 15 (so promotion/invalidation target the revision model directly) |
