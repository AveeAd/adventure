...
| **22 — Approval UI** | approved-vs-pending public rendering, "Unapproved" badge, "N unapproved changes" view with diff + vote buttons, approvers in history, review queue (public + admin) | Depends entirely on 21 |
