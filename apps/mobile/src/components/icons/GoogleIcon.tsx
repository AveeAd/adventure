...
// Google's official multicolor "G" mark - ported from apps/public's
// login.tsx GoogleIcon (same brand asset, react-native-svg instead of
// inline <svg> since RN has no native SVG element).
