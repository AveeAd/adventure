  ...
  return (
    <Container>
      <div className="flex items-center gap-2 text-primary-700 dark:text-primary-400">
        ...
        <span className="text-sm font-medium uppercase tracking-wide">Guide directory</span>
      </div>
      <h1 className="mt-1 text-2xl font-semibold text-stone-900 dark:text-stone-50">
        Find a local guide for your trek
      </h1>
      ...
      {guides.length === 0 ? (
        <div className="mt-6">
          <EmptyState>No guides match those filters.</EmptyState>
        </div>
      ) : (
