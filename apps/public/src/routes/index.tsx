            ...
            {(trails.length > 0 || spots.length > 0) && (
              <button
                ...
                className={`absolute right-2 top-1/2 flex -translate-y-1/2 items-center gap-1.5 rounded-full p-3 text-sm font-medium transition-all sm:px-4 sm:py-2.5 ${
                  showMap
                    ? "border-2 border-primary-400 bg-primary-500/25 text-primary-800 shadow-[0_0_9px_rgba(92,154,118,0.65)] backdrop-blur-lg before:pointer-events-none before:absolute before:inset-[3px] before:rounded-[inherit] before:border before:border-primary-400/70 before:shadow-[0_0_5px_rgba(92,154,118,0.5)] before:content-[''] dark:bg-primary-400/20 dark:text-primary-200"
