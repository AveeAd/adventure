...
**Real gaps identified against the brief** (surveyed; item 2 built as Phase 28, item 1 not yet built):
...
**Phased build plan**: see `UI_DESIGN_REFRESH_PLAN.md` — Phase 26 (empty-state copy, **built**) → Phase 27 (wiki-page anatomy audit, **built**, no gap found) → Phase 28 (trait-badge vocabulary, **built**) → Phase 29 (map-as-hero layout). Phase 29 not built yet; that doc is the phase-by-phase spec, this section stays the rationale/survey record.
